...
export async function POST({request}) {
    ...
    const { date, allow_k1, inputtedComposerCode, shouldReplaceStocks, replacementTicker, replacements} = await request.json();
    ...
    const NEW_COMPOSER_CODE = await tickerReplacer.replaceTickersInComposerCode(replacements);
